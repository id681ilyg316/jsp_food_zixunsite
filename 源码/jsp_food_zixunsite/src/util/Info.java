...
public class Info {
    ...
    public static String selectBuild3(String tabname,HashMap<String, String> selectmap,HashMap<String, String> selectymap,HashMap<String, String> selectbmap,HttpServletRequest request)
    {
	 ...
	 { 
		 String kjstr = "<script language=javascript src=\"/food_zixunsite/js/compl.js\"></script> \n";  
	...
	System.out.print(Info.getBetweenDayNumber("2012-11-11 11:19", "2012-11-11 11:11"));
	 ...
	 public static String getFileUpInfo()
		{
			String jscode = "";
			jscode+="<script src=/food_zixunsite/js/popup.js></script>";
	  ...
	  public static String tform(HashMap map)
		{
	    	...
	    	Set set = map.entrySet();
	    	 ...
	    	 jscode+=" if(f1."+str1+")\n";
	    	  ...
	    	  jscode+="{\n";
	    	  jscode+="document.getElementById(\"txt\").src=\"/food_zixunsite/upfile/"+map.get("filename")+"\";\n";
	    	  jscode+="}\n";
	    	  
	    	  jscode+="if(document.getElementById(\"txt2\"))\n";
	    	  jscode+="{\n";
	    	  jscode+="document.getElementById(\"txt2\").src=\"/food_zixunsite/upfile/"+map.get("filename2")+"\";\n";
	    	  jscode+="}\n";
	    	  
	    	  jscode+="if(document.getElementById(\"txt3\"))\n";
	    	  jscode+="{\n";
	    	  jscode+="document.getElementById(\"txt3\").src=\"/food_zixunsite/upfile/"+map.get("filename3")+"\";\n";
	    	  jscode+="}\n";
	    	  
	    	  jscode+="if(document.getElementById(\"txt4\"))\n";
	    	  jscode+="{\n";
	    	  jscode+="document.getElementById(\"txt4\").src=\"/food_zixunsite/upfile/"+map.get("filename4")+"\";\n";
	    	  jscode+="}\n";
	    	  
	    	  jscode+="if(document.getElementById(\"txt5\"))\n";
	    	  jscode+="{\n";
	    	  jscode+="document.getElementById(\"txt5\").src=\"/food_zixunsite/upfile/"+map.get("filename5")+"\";\n";
	    	  jscode+="}\n";
	...
	{
		String jscode = "";
		jscode+="<img style=\"cursor: hand;margin:3px\" onclick=\"uploadimg()\" src=\"/food_zixunsite/js/nopic.jpg\" id=txt height=\""+height+"\"/>";
		jscode+="<input type=hidden name=\"filename\" id=\"filename\" value=\"\" />";
		jscode+="<script type=\"text/javascript\"  src=\"/food_zixunsite/js/popups.js\"></script>";
		return jscode;
	}
	...
	{
		String jscode = "";
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg2()\" src=\"/food_zixunsite/js/nopic.jpg\" id=txt2 height=\""+height+"\"/>";
		jscode+="<input type=hidden name=\"filename2\" id=\"filename2\" value=\"\" />";
		jscode+="<script type=\"text/javascript\"  src=\"/food_zixunsite/js/popup.js\"></script>";
		return jscode;
	}
	...
	{
		String jscode = "";
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg3()\" src=\"/food_zixunsite/js/nopic.jpg\" id=txt3 height=\""+height+"\"/>";
	...
	{
		String jscode = "";
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg4()\" src=\"/food_zixunsite/js/nopic.jpg\" id=txt4 height=\""+height+"\"/>";
	...
	{
		String jscode = "";
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg5()\" src=\"/food_zixunsite/js/nopic.jpg\" id=txt5 height=\""+height+"\"/>";
	...
	public static String fck(int height,String content)
	{
		...
		jscode+="<script type=\"text/javascript\"  src=\"/food_zixunsite/fckeditor/ckeditor.js\"></script>";
	...
	public static String fck1(int height,String pduty)
	{
		...
		jscode+="<script type=\"text/javascript\"  src=\"/food_zixunsite/fckeditor/fckeditor.js\"></script>";
		jscode+="<script language=\"javascript\">";
		jscode+="function fckinit()";
		jscode+="{";
	    ...
	    public static void delPic(String path,String img)
		{
	     ...
	     public static String getCol(String type,String trid,String name,String url,String display)
	     {
   		 ...
   		 html=  "<table width=\"151\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\"> \n" +
					...
					"<tr>\n"+
					"<td height=\"23\" background=\"/food_zixunsite/frontfiles/images/main_47.gif\" id=\"imgmenu"+trid+"\" class=\"menu_title\" onmouseover=\"this.className='menu_title2';\" onclick=\"showsubmenu("+trid+")\" onmouseout=\"this.className='menu_title';\" style=\"cursor:hand\"><table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\n"+
					"<tr>\n"+
					"<td width=\"18%\">&nbsp;</td>\n"+
	    	 ...
	    	 {
   		 html=  "<tr> \n"+
                   "<td height=\"23\"><div align=\"center\"><img src=\"/food_zixunsite/frontfiles/images/left.gif\" width=\"10\" height=\"10\" /></div></td> \n"+
	    	 ...
	    	 {
   		 html=  "<tr> \n"+
                   "<td background=\"/food_zixunsite/frontfiles/images/main_51.gif\" id=\"submenu"+trid+"\" style=\"display:"+display+"\" ><div class=\"sec_menu\" > \n"+
			 ...
			 html=   "</table></td> \n"+
			         "</tr> \n"+
			         "<tr> \n"+
			         "<td height=\"5\"><img src=\"/food_zixunsite/frontfiles/images/main_52.gif\" width=\"151\" height=\"5\" /></td> \n"+
			         "</tr> \n"+
			         "</table> \n"+
			         "</div></td> \n"+
			         "</tr> \n"+
