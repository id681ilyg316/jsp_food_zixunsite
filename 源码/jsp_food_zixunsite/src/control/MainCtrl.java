...
public class MainCtrl extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (ac.equals("compl")) {
            ...
            response.sendRedirect("/food_zixunsite/pre.jsp?id=" + bid);
        }
            ...
            if (!pagerandom.equals(random) && request.getParameter("a") != null) {
                ...
                if (list.size() == 1) {
                    ...
                    if (ulist.size() == 1 && password.equals(map.get("upass").toString())) {
                        ...
                        gor("/food_zixunsite/index.jsp", request, response);
        ...
        if (ac.equals("uploaddoc")) {
            try {
                ...
                gor("/food_zixunsite/js/uploaddoc.jsp?docname=" + filename, request, response);
            } catch (Exception e1) {
                e1.printStackTrace();
            }
        }
        ...
        if (ac.equals("uploaddoc2")) {
            try {
                ...
                go("/food_zixunsite/js/uploaddoc2.jsp?docname=" + filename, request, response);
            } catch (Exception e1) {
                e1.printStackTrace();
            }
        }
        ...
        if (ac.equals("uploaddoc3")) {
            try {
                ...
                go("/food_zixunsite/js/uploaddoc3.jsp?docname=" + filename, request, response);
            } catch (Exception e1) {
                e1.printStackTrace();
            }
        }
        ...
        if (ac.equals("uploadimg2")) {
            try {
                ...
                go("/food_zixunsite/js/uploadimg2.jsp?filename=" + filename, request, response);
            } catch (Exception e1) {
                e1.printStackTrace();
            }
        }
        ...
        if (ac.equals("uploadimg3")) {
            try {
                ...
                go("/food_zixunsite/js/uploadimg3.jsp?filename=" + filename, request, response);
            } catch (Exception e1) {
                e1.printStackTrace();
            }
        }
        ...
        if (ac.equals("uploadimg4")) {
            try {
                ...
                go("/food_zixunsite/js/uploadimg4.jsp?filename=" + filename, request, response);
            } catch (Exception e1) {
                e1.printStackTrace();
            }
        }
        ...
        if (ac.equals("uploadimg5")) {
            try {
                ...
                go("/food_zixunsite/js/uploadimg5.jsp?filename=" + filename, request, response);
            } catch (Exception e1) {
                e1.printStackTrace();
            }
        }
        ...
        if (ac.equals("regedit")) {
            ...
            dao.commOper(sql);
            session.setAttribute("suc", "suc");
            response.sendRedirect("/food_zixunsite/regedit.jsp");
        }
        //regedit.jsp请求处理结束
        ...
        if (ac.equals("aprosxg")) {
            ...
            dao.commOper(sql);
            session.setAttribute("suc", "suc");
            response.sendRedirect("/food_zixunsite/admin/aprosxg.jsp?id=" + id + "");
        }
        //aprosxg.jsp请求处理结束
        ...
        if (ac.equals("uordersxg")) {
            ...
            dao.commOper(sql);
            session.setAttribute("suc", "suc");
            response.sendRedirect("/food_zixunsite/admin/uordersxg.jsp?id=" + id + "");
        }
        //uordersxg.jsp请求处理结束
        ...
        if (ac.equals("aordersxg")) {
            ...
            dao.commOper(sql);
            session.setAttribute("suc", "suc");
            response.sendRedirect("/food_zixunsite/admin/aordersxg.jsp?id=" + id + "");
        }
        //aordersxg.jsp请求处理结束
        ...
        if (ac.equals("sarticlexg")) {
            ...
            dao.commOper(sql);
            session.setAttribute("suc", "suc");
            response.sendRedirect("/food_zixunsite/admin/sarticlexg.jsp?id=" + id + "");
        }
        ...
        if (ac.equals("hysysusertj")) {
            ...
            dao.commOper(sql);
            session.setAttribute("suc", "suc");
            response.sendRedirect("/food_zixunsite/admin/hysysusertj.jsp");
        }
        ...
        if (ac.equals("hysysuserxg")) {
            ...
            dao.commOper(sql);
            session.setAttribute("suc", "suc");
            response.sendRedirect("/food_zixunsite/admin/hysysuserxg.jsp?id=" + id + "");
        }
        ...
        if (ac.equals("sysusertj")) {
            ...
            dao.commOper(sql);
            session.setAttribute("suc", "suc");
            response.sendRedirect("/food_zixunsite/admin/sysusertj.jsp");
        }
        //sysusertj.jsp请求处理结束
        ...
        if (ac.equals("sysuserxg")) {
            ...
            dao.commOper(sql);
            session.setAttribute("suc", "suc");
            response.sendRedirect("/food_zixunsite/admin/sysuserxg.jsp?id=" + id + "");
        }
        //sysuserxg.jsp请求处理结束
        ...
        if (ac.equals("psysuserxg")) {
            ...
            dao.commOper(sql);
            session.setAttribute("suc", "suc");
            response.sendRedirect("/food_zixunsite/admin/psysuserxg.jsp?id=" + id + "");
        }
        ...
        if (ac.equals("zmixinfoxg")) {
            ...
            dao.commOper(sql);
            session.setAttribute("suc", "suc");
            response.sendRedirect("/food_zixunsite/admin/zmixinfoxg.jsp?id=" + id + "");
        }
        ...
        if (ac.equals("messagesxg")) {
            ...
            dao.commOper(sql);
            session.setAttribute("suc", "suc");
            response.sendRedirect("/food_zixunsite/admin/messagesxg.jsp?id=" + id + "");
        }
        ...
        if (ac.equals("gmixinfoxg")) {
            ...
            dao.commOper(sql);
            session.setAttribute("suc", "suc");
            response.sendRedirect("/food_zixunsite/admin/gmixinfoxg.jsp?id=" + id + "");
        }
        ...
        if (ac.equals("hbnewstj")) {
            ...
            dao.commOper(sql);
            session.setAttribute("suc", "suc");
            response.sendRedirect("/food_zixunsite/admin/hbnewstj.jsp");
        }
        //hbnewstj.jsp请求处理结束
        ...
        if (ac.equals("hbnewsxg")) {
            ...
            dao.commOper(sql);
            session.setAttribute("suc", "suc");
            response.sendRedirect("/food_zixunsite/admin/hbnewsxg.jsp?id=" + id + "");
        }
        //hbnewsxg.jsp请求处理结束
        ...
        if (ac.equals("guidestj")) {
            ...
            dao.commOper(sql);
            session.setAttribute("suc", "suc");
            response.sendRedirect("/food_zixunsite/admin/guidestj.jsp");
        }
        //guidestj.jsp请求处理结束
        ...
        if (ac.equals("guidesxg")) {
            ...
            dao.commOper(sql);
            session.setAttribute("suc", "suc");
            response.sendRedirect("/food_zixunsite/admin/guidesxg.jsp?id=" + id + "");
        }
        //guidesxg.jsp请求处理结束
        ...
        if (ac.equals("prostj")) {
            ...
            dao.commOper(sql);
            session.setAttribute("suc", "suc");
            response.sendRedirect("/food_zixunsite/admin/prostj.jsp");
        }
        //prostj.jsp请求处理结束
        ...
        if (ac.equals("prosxg")) {
            ...
            dao.commOper(sql);
            session.setAttribute("suc", "suc");
            response.sendRedirect("/food_zixunsite/admin/prosxg.jsp?id=" + id + "");
        }
        //prosxg.jsp请求处理结束
        ...
        if (ac.equals("tgrouptj")) {
            ...
            dao.commOper(sql);
            session.setAttribute("suc", "suc");
            response.sendRedirect("/food_zixunsite/admin/tgrouptj.jsp");
        }
        //tgrouptj.jsp请求处理结束
        ...
        if (ac.equals("tgroupxg")) {
            ...
            dao.commOper(sql);
            session.setAttribute("suc", "suc");
            response.sendRedirect("/food_zixunsite/admin/tgroupxg.jsp?id=" + id + "");
        }
        //tgroupxg.jsp请求处理结束
        ...
        if (ac.equals("articletj")) {
            ...
            dao.commOper(sql);
            session.setAttribute("suc", "suc");
            response.sendRedirect("/food_zixunsite/admin/articletj.jsp");
        }
        //articletj.jsp请求处理结束
        ...
        if (ac.equals("articlexg")) {
            ...
            dao.commOper(sql);
            session.setAttribute("suc", "suc");
            response.sendRedirect("/food_zixunsite/admin/articlexg.jsp?id=" + id + "");
        }
        //articlexg.jsp请求处理结束
