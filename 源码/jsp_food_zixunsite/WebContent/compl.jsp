...
<form  action="/food_zixunsite/food_zixunsite?ac=compl&tglparentid="  name="f1"  onsubmit="return checkform();">
    ...
    <td width="300%" colspan="3">
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" id="standard_2">
        ...
        <tr style="display: none">
          ...
          <tr style="display: none">
          <td width="25%" height="32" align="center" valign="middle" class="ddd"><span class="left_txt2">餐厅（特色美食）名称：</span></td>
