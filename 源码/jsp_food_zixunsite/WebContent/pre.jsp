		  ...
		  <div class="container">
		    <div class="row">
		      <div class="">
		        <div class="row">
		          <div class="col-md-12">         
		            <h2 class="page-title" style="font-size: 17px;margin-top: 20px">当前位置: 美食推荐页面</h1> 
		          </div>
		        </div>
		      <div class="line2"></div>
		        ...
		        <h1 style="font-size: 23px;padding-top: 5px;padding-bottom: 5px;margin-bottom: 5px">
		         <img src="/food_zixunsite/upfile/<%=mmm.get("filename") %>" height="280" />
		        </h1>
		        </div>
...
<td width="21%" height="32" align="center">餐厅（特色美食）名称</td>
<td width="79%" align="left"  style="padding-left: 5px"><%=mmm.get("sname")%></td>
</tr>
<tr ng-repeat="x in names">
<td width="21%" height="32" align="center">所属区域</td>
...
<td width="79%" align="left"  style="padding-left: 5px"><%=mmm.get("tprice")%></td>
		       ...
		       <div class="row" style="margin-top: 20px">
				 ...
				 if(utype.equals("用户")){
				 %>
				  <form autocomplete="off" action="pre.jsp?id=<%=id %>&itype=<%=itype %>&g=g" name="f3" style="display: inline">  
				<center>
				 交通 : 
				<label>
