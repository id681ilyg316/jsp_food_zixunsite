...
<form name="f1" autocomplete="off"  action="gmixinfocx.jsp"  style="display: inline;font-size: 14px">
<center>
...
<tr ng-repeat="x in names">
    ...
    <td align="center" height=33><img src="/food_zixunsite/upfile/<%=map.get("filename")%>" height=75 width="240" /></td>
