...
<!-- servletformstart 
<form  action="/food_zixunsite/food_zixunsite?ac=hysysusertj&tglparentid=<%=tglparentid%>"   autocomplete="off"  style="display: inline;font-size: 15px" name="f1"  onsubmit="return checkform()" >
  servletformend -->
  <!-- s2formstart -->
<form name="f1" onsubmit="return checkform()" action="/food_zixunsite/food_zixunsite/hysysusertj.do?tglparentid=<%=tglparentid%>" > 
  <!-- s2formend -->
<center>
