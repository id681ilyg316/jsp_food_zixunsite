...
<!-- servletformstart -->
<form  action="/food_zixunsite/food_zixunsite?ac=aordersxg&id=<%=mmm.get("id")%>"   autocomplete="off"  style="display: inline;font-size: 15px" name="f1"  onsubmit="return checkform()" >
<!-- servletformend -->
<!-- s2formstart
sactionurl 
s2formend -->
