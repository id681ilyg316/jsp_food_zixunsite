...
<!-- servletformstart --> 
<form  action="/food_zixunsite/food_zixunsite?ac=uordersxg&id=<%=mmm.get("id")%>"   autocomplete="off"  style="display: inline;font-size: 15px" name="f1"  onsubmit="return checkform()" >
 <!-- servletformend -->
 <!-- s2formstart 
<form  name="f1"  onsubmit="return checkform()" action="/food_zixunsite/food_zixunsite/uordersxg.do?id=<%=mmm.get("id")%>" > 
   s2formend -->
<center>
