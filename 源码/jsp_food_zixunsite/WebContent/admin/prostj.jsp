...
<!-- servletformstart 
<form  action="/food_zixunsite/food_zixunsite?ac=prostj&tglparentid=<%=tglparentid%>"   autocomplete="off"  style="display: inline;font-size: 15px" name="f1"  onsubmit="return checkform()" >
  servletformend -->
  <!-- s2formstart -->
<form name="f1" onsubmit="return checkform()" action="/food_zixunsite/food_zixunsite/prostj.do?tglparentid=<%=tglparentid%>" > 
  <!-- s2formend -->
<center>
...
<tr ng-repeat="x in names">
<td width="21%" height="32" align="center">区域</td>
...
<tr ng-repeat="x in names">
<td width="21%" height="32" align="center">折扣（%）</td>
...
<tr ng-repeat="x in names">
<td width="21%" height="32" align="center">双人餐预计费用</td>
...
<tr ng-repeat="x in names">
<td width="21%" height="32" align="center">四人餐预计费用</td>
...
if(cityobj.value==""){  
document.getElementById("clabelcity").innerHTML="&nbsp;&nbsp;<font color=red>请输入区域</font>";  
return false;  
}else{
...
if(tpriceobj.value==""){  
document.getElementById("clabeltprice").innerHTML="&nbsp;&nbsp;<font color=red>请输入折扣（%）</font>";  
return false;  
}else{
...
if(hpriceobj.value==""){  
document.getElementById("clabelhprice").innerHTML="&nbsp;&nbsp;<font color=red>请输入双人餐预计费用</font>";  
return false;  
}else{
...
if(fpriceobj.value==""){  
document.getElementById("clabelfprice").innerHTML="&nbsp;&nbsp;<font color=red>请输入四人餐预计费用</font>";  
return false;  
}else{
