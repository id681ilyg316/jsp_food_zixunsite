...
<form name="f1" autocomplete="off"  action="pinluncx.jsp"  style="display: inline;font-size: 14px">
<center>
...
<input type=submit class='' value='查询信息' />
 &nbsp;
<!--   <jsp:include page='/food_zixunsite/pinluncx.do'>
...
if(tablename.equals("article"))tablename="网友美食分享推荐";
if(tablename.equals("pros"))tablename="美食推荐";
%>
<tr ng-repeat="x in names">
