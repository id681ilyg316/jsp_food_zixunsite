...
<form name="f1" autocomplete="off"  action="proscx.jsp"  style="display: inline;font-size: 14px">
<center>
...
<input type=submit class='' value='查询信息' />
 &nbsp;
<!--   <jsp:include page='/food_zixunsite/proscx.do'>
...
<td align="center" height=33>区域  </td>
<td align="center" height=33>折扣（%）  </td>
<td align="center" height=33>双人餐预计费用  </td>
<td align="center" height=33>四人餐预计费用  </td>
