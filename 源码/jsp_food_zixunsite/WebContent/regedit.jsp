...
<form name="f1" onsubmit="return checkform()" action="/food_zixunsite/food_zixunsite/regedit.do?a=a" > 
...
<tr ng-repeat="x in names">
   ...
   &nbsp; <img src="/food_zixunsite/frontfiles/images/input.png" width="16px" height="16px"  > &nbsp;
    当前位置 : 用户注册
	</td> 
</tr> 
...
if(unameobj.value!=""){  
var ajax = new AJAX();
ajax.post(encodeURI("/food_zixunsite/factory/checkno.jsp?table=sysuser&col=uname&value="+unameobj.value+"&checktype=insert&ttime=<%=Info.getDateStr()%>")) 
//ajax.post("/food_zixunsite/factory/checkno.jsp?table=sysuser&col=uname&value="+unameobj.value+"&checktype=insert&ttime=<%=Info.getDateStr()%>") 
...
if(sfidobj.value!=""){  
var ajax = new AJAX();
ajax.post(encodeURI("/food_zixunsite/factory/checkno.jsp?table=sysuser&col=sfid&value="+sfidobj.value+"&checktype=insert&ttime=<%=Info.getDateStr()%>")) 
//ajax.post("/food_zixunsite/factory/checkno.jsp?table=sysuser&col=sfid&value="+sfidobj.value+"&checktype=insert&ttime=<%=Info.getDateStr()%>") 
var msg = ajax.getValue();
if(msg.indexOf('Y')>-1){
