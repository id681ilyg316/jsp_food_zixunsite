...
<div class="">
 ...
 <table><tr><td height=40></td></tr></table>
        ...
        <center>
          <form action="/food_zixunsite/food_zixunsite/login.do?a=a" style="display: inline">
                 ...
                 <thead>
                  ...
                  <tr>
                    ...
                    <input  name=pagerandom id="pagerandom" type=text value="" maxLength=4 size=10>
                              ...
                              <img src="/food_zixunsite/admin/ma.jsp" style="vertical-align:-28%;" id="yzm" ></img> &nbsp; <span onClick="ma();" style="cursor: hand"  class="login_txt">换一张</span>
                              <script type="text/javascript">
                              function ma()
                              {
                              var a = document.getElementById("yzm");
                              var myDate=new Date()
                              a.src="/food_zixunsite/admin/ma.jsp?d="+myDate;
                              }
